...
def upload():
    upload_name = request.files['PDF'].filename

    # 新建一个空白pdf
    pdfWriter = PyPDF2.PdfFileWriter()

    # 循环获取pdf
    zip = zipfile.ZipFile(upload_name, 'r')
    ...
    # 设置response头
    response = make_response(send_file("../marge.pdf"))
    response.headers["Content-Disposition"] = "attachment; filename=" + "upload_name.pdf;"
